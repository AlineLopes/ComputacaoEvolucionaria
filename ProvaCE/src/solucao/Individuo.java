...
public class Individuo implements Comparable<Individuo>{
    ...
    public void criar() {
        ...
        for (int i = 0; i < this.getNumeroVariaveis(); i++) {
            ...
            } while (valor < getInterMin() || valor > getInterMax());
    ...
    public Object clone() throws CloneNotSupportedException {
        Individuo individuo = new Individuo(this.getInterMin(), this.getInterMax(), this.getNumeroVariaveis());
        individuo.setCromossomos(new ArrayList<>(this.getCromossomos()));
        individuo.setFuncaoObjetivo(this.getFuncaoObjetivo());
        return individuo; //To change body of generated methods, choose Tools | Templates.
    }
